        ...
        <div className='w-full background-3 '>
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-3xl mx-auto">
             <AnimateScroll  text={"About me"} className={` font-semibold text-6xl max-xl:text-6xl 2xl:text-7xl w-70 rounded-lg textgradient2 text-slate-300`}/>
              <div className="space-y-6 max-lg:text-lg 2xl:text-2xl  text-gray-300">
                ...
                <div className="mt-8">
                  <h3 className="text-2xl max-2xl:text-3xl font-semibold text-orange-400 mb-4">Skills</h3>
                  ...
                  <button className="mt-6 px-6 py-2 bg-transparent border max-2xl:text-xl border-yellow-400 text-white rounded-md hover:bg-yellow-500 transition-colors">
