...
function Layouts() {
    return (
        ...
        <motion.h1 initial={{opacity:0}} whileInView={{opacity:100}} transition={{delay:0.3, duration:1 , ease:easeIn}} className='header text-6xl max-xl:text-7xl max-md:text-4xl font-bold'>Transforming websites to next level and better user experience</motion.h1>
        </div>
        <div className='w-full h-full mb-2 mt-4  flex'>
         ...
         <Animatetext text={'Bringing creativity and code together!'} className={'header text-4xl max-xl:text-5xl max-md:text-2xl text-end  text-white  font-bold '}/>
         </div>
