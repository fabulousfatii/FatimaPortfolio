...
function Layouts() {
    return (
        ...
        <motion.h1 initial={{opacity:0}} whileInView={{opacity:100}} transition={{delay:0.3, duration:1 , ease:easeIn}} className='header text-6xl 2xl:text-7xl max-md:text-4xl font-bold'>Transforming websites to next level and better user experience</motion.h1>
        </div>
