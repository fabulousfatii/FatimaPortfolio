      ...
      <section>
        ...
        <section ref={social} className={`social w-full h-screen background-3 ${responsive? "hidden" : " "}   p-10 max-md:p-3 relative flex justify-end`}>
          ...
          <Canvas camera={{fov: 12, position: [-16, -8, 180]}}>
           ...
           <div className='absolute   2xl:bottom-20  right-14 max-md:right-0 max-md:top-3 max-md:ml-4 max-md:bottom-80 bottom-20 flex max-md:flex-row max-sm:flex-col justify-end max-md:justify-start items-start p-8 max-sm:p-0 max-sm:mr-0 mr-8 flex-col gap-3 max-md:gap-4'>
