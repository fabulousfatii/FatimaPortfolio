...
function Projectcard({title,description,image,link}) {
    return (
<a href={link} className=' w-96 2xl:w-[410px] max-md:w-72 max-sm:w-60  h-80 z-40 rounded-xl flex flex-col justify-start p-6  border relative overflow-hidden hover:scale-105 transition-all duration-200 cursor-pointer '>
